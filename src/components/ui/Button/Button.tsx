...
const buttonVariants = cva(
    "inline-flex items-center justify-center rounded-md text-sm font-medium ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
    {
        variants: {
            variant: {
                default: "bg-black text-primary-foreground hover:bg-neutral-950 hover:translate-y-[2px]",
                themed: "bg-[#CC4B00] text-primary-foreground hover:bg-[#e06d2f] hover:translate-y-[2px]",
                destructive:
                    "bg-destructive text-destructive-foreground hover:bg-destructive/90 hover:translate-y-[2px]",
                outline: "shadow-sm border bg-background hover:text-foreground hover:translate-y-[2px]",
                secondary: "bg-secondary text-secondary-foreground hover:bg-secondary/80 hover:translate-y-[2px]",
                other: "bg-ring text-primary-foreground hover:bg-ring/90",
                translucent: "bg-background/90 hover:bg-background/80 border",
