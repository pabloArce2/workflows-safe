...
const shortFormat = ({ hours, minutes, seconds }: Duration): string => {
    ...
    const shortestVariant = [totalSeconds.toPrecision(2), totalSeconds.toFixed(2), String(totalSeconds)]
    ...
    return (
        ...
        >
            <HStack
                ...
                width="auto"
            >
                <Icon as={BiStopwatch} boxSize="0.75rem" color="var(--node-timer-fg)" />
                <Text color="var(--node-timer-fg)" fontSize="xx-small" fontWeight="500" m={0} textAlign="right">
