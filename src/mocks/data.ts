...
const initialNodesSchema: NodeSchema[] = [
...

  {
    ...
    name: "Solicitar detecciones e imágenes",
    category: "data-capture" as CategoryId,
    nodeGroup: "camera" as NodeGroupId,
    ...
    inputs: [
      {
        ...
        label: "Cámara",
        optional: false,
        options: [{ option: "camera_cenital", value: "camera_cenital", type: "string" }],
        preferredStyle: "dropdown",
        groups: [],
      },
    ],
    outputs: [
      ...
      {
        id: "output-image-path" as OutputId,
        type: "string",
        label: "Ruta de la imagen",
        kind: "text",
        description: "Ruta de la imagen capturada por la cámara.",
      },
    ],
  },
  {
