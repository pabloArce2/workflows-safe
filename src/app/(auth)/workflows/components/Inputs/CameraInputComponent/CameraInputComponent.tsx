...
import { InputSchemaValue, TextInput } from "@/common/common-types"
...
interface CameraInputComponentProps {
    field: any
...
const CameraInputComponent: React.FC<CameraInputComponentProps> = ({ field, inputSchema, open, onOpenChange }) => {
