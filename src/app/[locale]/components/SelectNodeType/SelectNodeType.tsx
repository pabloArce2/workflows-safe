          ...
          render={({ field }) => {
            return (
              <FormItem className="flex flex-col">
                ...
                <FormDescription className="">This is the type that will be asign to this node.</FormDescription>
                <FormMessage />
              </FormItem>
            )
          }}
    ...
    <>
      {category.groups.map((group) => {
        ...
        return schemas.map((schema, index) => (
          ...
          >
            <Icons.check
              className={cn("mr-2 h-4 w-4", field.value === schema.name ? "opacity-100" : "opacity-0")}
            />
